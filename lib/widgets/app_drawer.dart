...
class _AppDrawerState extends State<AppDrawer> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    ...
                    _DrawerTile(title: l10n.shareApp, iconPath: 'assets/icons/misc/share_icon.png', iconTint: _primaryBlue, onTap: () => SharePlus.instance.share(ShareParams(text: l10n.shareMessage(_playStoreUrl)))),
  ...
  void _navigateToShell(BuildContext context, int index) {
    FirebaseAnalytics.instance.logEvent(name: 'drawer_navigation', parameters: {'tab_index': index});
  ...
  void _navigateToScanner(BuildContext context) {
    FirebaseAnalytics.instance.logEvent(name: 'drawer_navigation', parameters: {'screen': 'Scanner'});
    Navigator.pop(context);
  ...
  void _navigateToCreate(BuildContext context) {
    FirebaseAnalytics.instance.logEvent(name: 'drawer_navigation', parameters: {'screen': 'Create'});
    Navigator.pop(context);
    Navigator.push(context, MaterialPageRoute(builder: (_) => const CreateQRScreen()));
  }

  void _navigateToMyQr(BuildContext context) {
    FirebaseAnalytics.instance.logEvent(name: 'drawer_navigation', parameters: {'screen': 'MyQR'});
    Navigator.pop(context);
    Navigator.push(context, MaterialPageRoute(builder: (_) => const MyQrScreen()));
  }

  Future<void> _scanFromGallery() async {
    FirebaseAnalytics.instance.logEvent(name: 'scan_gallery_start', parameters: {'source': 'drawer'});
  ...
  Future<void> _toggleTheme(BuildContext context) async {
    FirebaseAnalytics.instance.logEvent(name: 'drawer_change_theme');
    Navigator.pop(context);
