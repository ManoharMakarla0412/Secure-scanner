...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  void initState() {
    super.initState();
    FirebaseAnalytics.instance.logEvent(name: 'onboarding_start');
    FirebaseAnalytics.instance.logScreenView(screenName: 'OnboardingPage_0');
  }
                ...
                Expanded(
                  child: PageView.builder(
                    ...
                    onPageChanged: (value) {
                      ...
                      FirebaseAnalytics.instance.logScreenView(screenName: 'OnboardingPage_$value');
                    },
              ...
              return Padding(
                ...
                child: InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: isSelected
                          ? const Color(0xFF006EFF).withValues(alpha: 0.1)
                          : Colors.grey[50],
                      borderRadius: BorderRadius.circular(15),
                      border: Border.all(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextStyle(
                                  fontSize: 14,
                                  color: isSelected
                                      ? const Color(0xFF006EFF).withValues(alpha: 0.7)
                                      : Colors.black54,
                                ),
                              ),
                            ],
