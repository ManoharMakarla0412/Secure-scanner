        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: SecureScanTheme.accentBlue.withValues(alpha: 0.1),
...
class _CreateQRCodePageState extends State<CreateQRCodePage> {
        ...
        return Column(
          children: [
            ...
            DropdownButtonFormField<String>(
              initialValue: _controller.encryptionValue,
          ...
          children: [
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                ...
                elevation: 0,
                side: BorderSide(color: SecureScanTheme.accentBlue.withValues(alpha: 0.5)),
  ...
  InputDecoration _inputDecoration(String label, ColorScheme colorScheme, TextTheme textTheme) {
    return InputDecoration(
      labelText: label,
      labelStyle: TextStyle(color: colorScheme.onSurface.withValues(alpha: 0.7), fontSize: 14),
    ...
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: SecureScanTheme.accentBlue.withValues(alpha: 0.3),
              blurRadius: 15,
              offset: const Offset(0, 8),
            ),
          ],
       ...
       child: ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
          ...
          shape: RoundedRectangleBorder(
            ...
            side: isFullWidth ? BorderSide.none : BorderSide(color: colorScheme.outline.withValues(alpha: 0.1)),
          ),
          elevation: 0,
        ),
      ),
